    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <?php endif ?>
                <form action="/tbtk/tambah_data_keuangan/<?= $tbtk->slug_nama_lengkap ?>" method="post"
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    ?>
                                    <br>
                                    <h5>yang akan menempuh pendidikan di <b><?= $sub_unit ?> Santa Ursula</b> Tahun
                                    ...
                                    <h5>2. Alat dan Bahan Prakarya</h5>
                                    <h5>3. UKGS</h5>
                                    <h5>4. Eksploring 1 Tahun</h5>
                                    <h5>5. Ekstrakurikuler Selama 1 Tahun</h5>
                                    <h5>6. Etika Makan Selama 1 Tahun</h5>
                                    <br>
                                    ...
                                    <h5>2. Segala bentuk pertanyaan dapat menghubungi kontak Panitia PPDB TB-TK Santa
                                    ...
                                    <h5>3. Pembayaran dilakukan dengan mentransfer ke Virtual Account yang didapatkan
                                        saat pendaftaran yaitu : <b><?= $tbtk->no_virtual ?></b>.</h5>
