    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <form action="/tbtk/update_data_pendaftaran/<?= $tbtk->id ?>" method="post"
                    enctype="multipart/form-data">
                    <?= csrf_field() ?>
                    <input type="hidden" name="slug_nama_lengkap" value="<?= $tbtk->slug_nama_lengkap ?>">
                    <input type="hidden" name="bukti_pembayaran" value="<?= $tbtk->bukti_pembayaran ?>">
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group row align-items-center">
                                        ...
                                        <div class="col-lg-9 col-9">
                                            <input type="text" id="nama_lengkap" name="nama_lengkap"
                                                ...
                                                value="<?= (old('nama_lengkap')) ? old('nama_lengkap') : $tbtk->nama_lengkap ?>">
                                    ...
                                    <div class="form-group row align-items-center">
                                        ...
                                        <div class="col-lg-9 col-9">
                                            <input type="text" id="kota_lahir" name="kota_lahir"
                                                ...
                                                value="<?= (old('kota_lahir')) ? old('kota_lahir') : $tbtk->kota_lahir ?>">
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="form-group row align-items-center">
                                        ...
                                        <div class="col-lg-9 col-9">
                                            <input type="date" id="tanggal_lahir" name="tanggal_lahir"
                                                ...
                                                value="<?= (old('tanggal_lahir')) ? old('tanggal_lahir') : $tbtk->tanggal_lahir ?>">
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="form-group row align-items-center">
                                        ...
                                        <div class="col-lg-9 col-9">
                                            <input type="text" id="asal_sekolah" name="asal_sekolah"
                                                ...
                                                value="<?= (old('asal_sekolah')) ? old('asal_sekolah') : $tbtk->asal_sekolah ?>">
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="form-group row align-items-center">
                                        ...
                                        <div class="col-lg-9 col-9">
                                            <input type="text" id="nama_orangtua" name="nama_orangtua"
                                                ...
                                                value="<?= (old('nama_orangtua')) ? old('nama_orangtua') : $tbtk->nama_orangtua ?>">
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="form-group row align-items-center">
                                        ...
                                        <div class="col-lg-9 col-9">
                                            <input type="text" id="no_whatsapp" name="no_whatsapp"
                                                ...
                                                value="<?= (old('no_whatsapp')) ? old('no_whatsapp') : $tbtk->no_whatsapp ?>">
                                            <div class="invalid-feedback">
