    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <?php endif ?>
                <?php if($tahap === '1') : ?>
                <form action="/tbtk/bukti_pembayaran_tahap_1/<?= $tbtk->slug_nama_lengkap ?>" method="post"
                ...
                <?php endif ?>
                <?php if($tahap === '2') : ?>
                <form action="/tbtk/bukti_pembayaran_tahap_2/<?= $tbtk->slug_nama_lengkap ?>" method="post"
                    enctype="multipart/form-data">
                    <?= csrf_field() ?>
                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label required">Tanggal Pembayaran</label>
                ...
                <?php endif ?>
                <?php if($tahap === '3') : ?>
                <form action="/tbtk/bukti_pembayaran_tahap_3/<?= $tbtk->slug_nama_lengkap ?>" method="post"
                    enctype="multipart/form-data">
                    <?= csrf_field() ?>
                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label required">Tanggal Pembayaran</label>
                ...
                <?php endif ?>
                <?php if($tahap === '4') : ?>
                <form action="/tbtk/bukti_pembayaran_tahap_4/<?= $tbtk->slug_nama_lengkap ?>" method="post"
                    enctype="multipart/form-data">
                    <?= csrf_field() ?>
                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label required">Tanggal Pembayaran</label>
