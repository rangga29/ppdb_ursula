...
<?php if(($tbtk->status_pendaftaran === '3') && ($tbtk->status_penerimaan === '2')) : ?>
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                <h1 class="card-title mt-0">
                    <b>SELAMAT</b><br>Kamu Berhasil Diterima di TB-TK Santa Ursula
                </h1>
            </div>
        </div>
    </div>
...
<?php if(($tbtk->status_pendaftaran === '3') && ($tbtk->status_penerimaan === '3')) : ?>
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                <h1 class="card-title mt-0">
                    <b>MOHON MAAF</b><br>Kamu Belum Berhasil Diterima di TB-TK Santa Ursula
                </h1>
            </div>
        </div>
    </div>
...
($tbtk->status_dapodik === '1' || $tbtk->status_dapodik === '2') && 
($tbtk->status_keuangan === '1' || $tbtk->status_keuangan === '2')) : 
?>
<div class="row">
    <div class="col-lg-12">
        <div class="card">
...
<?php if($tbtk->status_penerimaan === '2' && 
$tbtk->status_dapodik === '3' && 
$tbtk->status_keuangan === '3' && 
($tbtk->status_seragam === '1' || $tbtk->status_seragam === '2') && 
($tbtk->status_buku === '1' || $tbtk->status_buku === '2')) : 
?>
<div class="row">
    <div class="col-lg-12">
        <div class="card">
                    ...
                    <div class="card-body">
                        <div class="jumbotron bg-light">
                            <h1 class="display-6 text-center">
                                <b>DASHBOARD CALON PESERTA DIDIK <br>PPDB 2022/2023 <br>TB-TK SANTA URSULA BANDUNG</b>
                            </h1>
                            ...
                            <?php if($tbtk->status_penerimaan === '1') : ?>
                            <h4 class="text-justify">Terima kasih telah mendaftar di TB-TK Santa Ursula Bandung.
                            ...
                            <!-- Jika Status Penerimaan Diterima -->
                            <?php if($tbtk->status_penerimaan === '2') : ?>
                            <h4 class="text-justify">Selamat karena sudah diterima di TB-TK Santa Ursula Bandung. Proses
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="card card-body text-center">
                    ...
                    <a href="/<?= $slug_unit ?>/data_dapodik/<?= $tbtk->slug_nama_lengkap ?>" type="button"
            ...
            <div class="col-lg-12">
                <div class="card card-body text-center">
                    ...
                    <?php if($tbtk->status_pernyataan === '1') : ?>
                    <a href="/<?= $slug_unit ?>/data_pernyataan/<?= $tbtk->slug_nama_lengkap ?>" type="button"
                        class="btn btn-primary" style="color: white;">
                        FORM DATA PERNYATAAN
                    </a>
                    <?php endif ?>
                    <!-- Jika Status Pernyataan Belum Diverifikasi -->
                    <?php if($tbtk->status_pernyataan === '2') : ?>
                    <button type="button" class="btn btn-warning" disabled>
                        <i class="dripicons-search"></i> PROSES VERIFIKASI
                    </button>
                    <?php endif ?>
                    <!-- Jika Status Pernyataan Sudah Diverifikasi -->
                    <?php if($tbtk->status_pernyataan === '3') : ?>
                    <button type="button" class="btn btn-success" disabled>
                        <i class="dripicons-checkmark"></i> TERVERIFIKASI
                    </button>
                    <?php endif ?>
            ...
            <div class="col-lg-12">
                <div class="card card-body text-center">
                    ...
                    <a href="/<?= $slug_unit ?>/data_keuangan/<?= $tbtk->slug_nama_lengkap ?>" type="button"
                        class="btn btn-primary" style="color: white;">
                        FORM DATA KEUANGAN
                    </a>
                    <?php endif ?>
