                        ...
                        <div class="col-lg-8 align-self-center mb-3 mb-lg-0">
                            <div class="met-profile-main">
                                ...
                                <div class="met-profile_user-detail">
                                    <h5 class="met-user-name"><?= $tbtk->nama_lengkap ?></h5>
                                    <p class="mb-0 met-user-name-post">
                                        <b>Calon Peserta Didik <?= $tingkat ?></b> - <b><?= $unit ?></b>
                                    </p>
                                </div>
                            </div>
                        </div>
...
<div class="row">
    <div class="col-12">
        <div class="tab-content detail-list" id="pills-tabContent">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table mb-0 table-centered">
                                        <tbody>
                                            <tr>
                                                <a href="/<?= $slug_unit ?>/ubah_data_pendaftaran/<?= $tbtk->slug_nama_lengkap ?>"
                                                    class="btn btn-lg btn-primary btn-block <?= ($tbtk->status_pendaftaran === '3' ? 'disabled' : '') ?>">
                                    ...
                                    <table class="table mb-0 table-centered">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?= $tbtk->asal_sekolah ?></td>
                                            </tr>
                                            <tr>
                                                <td><b>Nama Orangtua</b></td>
                                                <td><?= $tbtk->nama_orangtua ?></td>
                                            </tr>
                                            <tr>
                                                <td><b>No. Whatsapp</b></td>
                                                <td><?= $tbtk->no_whatsapp ?></td>
                                            </tr>
                                            <tr>
                                                <td><b>Bukti Pembayaran</b></td>
                                                <td>
                                                    <img src="<?= base_url() ?>/upload/bukti_pembayaran/<?= $slug_unit ?>/<?= $tbtk->bukti_pembayaran ?>"
            ...
            <?php if(($tbtk->status_penerimaan === '2') && ($tbtk->status_dapodik === '1')) : ?>
            ...
            <?php endif ?>
            <?php if(($tbtk->status_penerimaan === '2') && (($tbtk->status_dapodik === '2') || $tbtk->status_dapodik === '3')) : ?>
            <div class="tab-pane fade" id="data_peserta_didik">
                <div class="row">
                    <div class="col-lg-9">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table mb-0 table-centered">
                                        <tbody>
                                            <tr>
                                                <a href="/<?= $slug_unit ?>/ubah_data_dapodik/<?= $tbtk->slug_nama_lengkap ?>"
                                                    class="btn btn-lg btn-primary btn-block <?= ($tbtk->status_dapodik === '3' ? 'disabled' : '') ?>">
            ...
            <?php endif ?>
            <?php if(($tbtk->status_penerimaan === '2') && ($tbtk->status_pernyataan === '1')) : ?>
            ...
            <?php endif ?>
            <?php if(($tbtk->status_penerimaan === '2') && (($tbtk->status_pernyataan === '2') || $tbtk->status_pernyataan === '3')) : ?>
            <div class="tab-pane fade" id="data_pernyataan">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
            ...
            <?php endif ?>
            <?php if(($tbtk->status_penerimaan === '2') && ($tbtk->status_keuangan === '1')) : ?>
            ...
            <?php endif ?>
            <?php if(($tbtk->status_penerimaan === '2') && (($tbtk->status_keuangan === '2') || $tbtk->status_keuangan === '3')) : ?>
            <div class="tab-pane fade" id="data_keuangan">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                                            ...
                                            <table class="table mb-0 table-centered">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="/<?= $slug_unit ?>/pembayaran_tahap_1/<?= $tbtk->slug_nama_lengkap ?>"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="/<?= $slug_unit ?>/pembayaran_tahap_2/<?= $tbtk->slug_nama_lengkap ?>"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="/<?= $slug_unit ?>/pembayaran_tahap_3/<?= $tbtk->slug_nama_lengkap ?>"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="/<?= $slug_unit ?>/pembayaran_tahap_4/<?= $tbtk->slug_nama_lengkap ?>"
