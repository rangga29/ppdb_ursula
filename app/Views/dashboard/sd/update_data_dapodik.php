    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <form action="/sd/update_data_dapodik/<?= $dapodik->id ?>" method="post" enctype="multipart/form-data">
                    <?= csrf_field() ?>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="no_registrasi" value="<?= $sd->no_registrasi ?>"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="email" value="<?= $sd->email ?>" disabled
                                                class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="pilihan_tingkat" class="form-control"
                                                value="Kelas <?= $sd->pilihan_tingkat ?>" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <p></p>
                                            <hr>
                                            <img src="<?= base_url() ?>/upload/pas_foto/sd/<?= $dapodik->pas_foto ?>"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <p>File Scan Kartu Keluarga Bertipe JPEG/JPG/PNG.<br>Hasil Scan Posisi Datar
                                                dan Jelas.</p>
                                            <hr>
                                            <img src="<?= base_url() ?>/upload/scan_kk/sd/<?= $dapodik->scan_kk ?>"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <p>File Scan Akta Kelahiran Bertipe JPEG/JPG/PNG.<br>Hasil Scan Posisi Datar
                                                dan Jelas.</p>
                                            <hr>
                                            <img src="<?= base_url() ?>/upload/scan_ak/sd/<?= $dapodik->scan_ak ?>"
