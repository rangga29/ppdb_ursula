                        ...
                        <div class="col-lg-8 align-self-center mb-3 mb-lg-0">
                            <div class="met-profile-main">
                                ...
                                <div class="met-profile_user-detail">
                                    <h5 class="met-user-name"><?= $sd->nama_lengkap ?></h5>
                                    <p class="mb-0 met-user-name-post">
                                        <b>Calon Peserta Didik Kelas <?= $sd->pilihan_tingkat ?></b> -
                                        <b><?= $unit ?></b>
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4 ml-auto">
                            <ul class="list-unstyled personal-detail">
                                <li class=""><i class="dripicons-document-new mr-2 text-info font-18"></i>
                                    <b> No. Pendaftaran </b> : <?= $sd->no_registrasi ?>
                                </li>
                                <li class="mt-3"><i class="dripicons-document text-info font-18 mt- mr-2"></i>
                                    <b> No. Virtual Account </b> : <?= $sd->no_virtual ?>
                                </li>
...
<div class="row">
    <div class="col-12">
        <div class="tab-content detail-list" id="pills-tabContent">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table mb-0 table-centered">
                                        <tbody>
                                            <tr>
                                                <a href="/<?= $slug_unit ?>/ubah_data_pendaftaran/<?= $sd->slug_nama_lengkap ?>"
                                                    class="btn btn-lg btn-primary btn-block <?= ($sd->status_pendaftaran === '3' ? 'disabled' : '') ?>">
                                    ...
                                    <table class="table mb-0 table-centered">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?= $sd->nama_orangtua ?></td>
                                            </tr>
                                            <tr>
                                                <td><b>No. Whatsapp</b></td>
                                                <td><?= $sd->no_whatsapp ?></td>
                                            </tr>
                                            <tr>
                                                <td><b>Bukti Pembayaran</b></td>
                                                <td>
                                                    <img src="<?= base_url() ?>/upload/bukti_pembayaran/<?= $slug_unit ?>/<?= $sd->bukti_pembayaran ?>"
                                                        alt="<?= $sd->nama_lengkap ?>" style="max-width: 300px;">
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
            ...
            <?php if(($sd->status_penerimaan === '2') && ($sd->status_dapodik === '1')) : ?>
            ...
            <?php endif ?>
            <?php if(($sd->status_penerimaan === '2') && (($sd->status_dapodik === '2') || $sd->status_dapodik === '3')) : ?>
            <div class="tab-pane fade" id="data_peserta_didik">
                <div class="row">
                    <div class="col-lg-9">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table mb-0 table-centered">
                                        <tbody>
                                            <tr>
                                                <a href="/<?= $slug_unit ?>/ubah_data_dapodik/<?= $sd->slug_nama_lengkap ?>"
                                                    class="btn btn-lg btn-primary btn-block <?= ($sd->status_dapodik === '3' ? 'disabled' : '') ?>">
            ...
            <?php endif ?>
            <?php if(($sd->status_penerimaan === '2') && ($sd->status_pernyataan === '1')) : ?>
            ...
            <?php endif ?>
            <?php if(($sd->status_penerimaan === '2') && (($sd->status_pernyataan === '2') || $sd->status_pernyataan === '3')) : ?>
            <div class="tab-pane fade" id="data_pernyataan">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
            ...
            <?php endif ?>
            <?php if(($sd->status_penerimaan === '2') && ($sd->status_keuangan === '1')) : ?>
            ...
            <?php endif ?>
            <?php if(($sd->status_penerimaan === '2') && (($sd->status_keuangan === '2') || $sd->status_keuangan === '3')) : ?>
            <div class="tab-pane fade" id="data_keuangan">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                                            ...
                                            <table class="table mb-0 table-centered">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="/<?= $slug_unit ?>/pembayaran_tahap_1/<?= $sd->slug_nama_lengkap ?>"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="/<?= $slug_unit ?>/pembayaran_tahap_2/<?= $sd->slug_nama_lengkap ?>"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="/<?= $slug_unit ?>/pembayaran_tahap_3/<?= $sd->slug_nama_lengkap ?>"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="/<?= $slug_unit ?>/pembayaran_tahap_4/<?= $sd->slug_nama_lengkap ?>"
