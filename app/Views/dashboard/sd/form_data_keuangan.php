    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <?php endif ?>
                <form action="/sd/tambah_data_keuangan/<?= $sd->slug_nama_lengkap ?>" method="post"
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="nama_lengkap" value="<?= $sd->nama_lengkap ?>"
                                    ...
                                    ?>
                                    <br>
                                    <h5>yang akan menempuh pendidikan di <b>SD Santa Ursula</b> Tahun
                                    ...
                                    <h5>2. Segala bentuk pertanyaan dapat menghubungi kontak Panitia PPDB SD Santa
                                    ...
                                    <h5>3. Pembayaran dilakukan dengan mentransfer ke Virtual Account yang didapatkan
                                        saat pendaftaran yaitu : <b><?= $sd->no_virtual ?></b>.</h5>
