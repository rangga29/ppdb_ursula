    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <?php endif ?>
                <form action="/sd/tambah_data_pernyataan/<?= $sd->slug_nama_lengkap ?>" method="post"
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="ttl"
                                                value="<?= $sd->kota_lahir ?>, <?= $tanggal_lahir ?>" disabled
                                                class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    ?>
                                    <h5>Dengan ini menyatakan bahwa jika anak kami diterima di SD KATOLIK
                                        ...
                                        pendidikannya di SD KATOLIK SANTA URSULA BANDUNG.
                                    </h5>
                                    <br>
