                ...
                <div class="card">
                    <div class="card-body text-center">
                        <h4 class="mt-0 header-title">
                            Formulir Pendaftaran Calon Peserta Didik SMP Santa Ursula [Jalur Internal]
                        </h4>
                    </div>
                </div>
                <form action="/smp_registrasi/internal_save" method="post" enctype="multipart/form-data">
                    <?= csrf_field() ?>
                    <div class="card">
                        <div class="card-body">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <hr>
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">Surat Pengantar</label>
                                        <div class="col-sm-10">
                                            <div class="custom-file">
                                                <input type="file" name="surat_pengantar" id="surat_pengantar"
                                                    class="custom-file-input <?= ($validation->hasError('surat_pengantar')) ? 'is-invalid' : '' ?>"
                                                    aria-describedby="surat_pengantar">
                                                <label class="custom-file-label" for="surat_pengantar">Choose
                                                    file</label>
                                                <div class="invalid-feedback">
                                                    <?= $validation->getError('surat_pengantar') ?>
                                                </div>
                                                Diharapkan file surat pengantar jelas dan mudah dibaca dan bertipe PDF.
                                            </div>
                                            <hr>
                                            <canvas id="pdfViewer" class="pdf-preview"></canvas>
                                        </div>
                                    </div>
                                </div>
                            </div>
