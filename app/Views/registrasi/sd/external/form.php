                ...
                <div class="card">
                    <div class="card-body text-center">
                        <h4 class="mt-0 header-title">
                            Formulir Pendaftaran Calon Peserta Didik SD Santa Ursula [Jalur External]
                        </h4>
                    </div>
                </div>
                <form action="/sd_registrasi/external_save" method="post" enctype="multipart/form-data">
                    <?= csrf_field() ?>
                    <div class="card">
                        <div class="card-body">
