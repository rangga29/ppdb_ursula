                ...
                <div class="card-body">
                    <div class="px-3">
                        ...
                        <div class="text-center auth-logo-text">
                            <h3 class="mt-0 mb-3 mt-5">KETENTUAN PPDB ONLINE TB-TK SANTA URSULA</h3>
                            <div class="row">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12 col-lg-11">
                                                    <p class="text-justify">
                                                        ...
                                                        administrasi sebesar <b>Rp. 150.000,00</b> yang dapat
                                                        ditrasfer melalui rekening <b>Bank Mandiri : 13 100 7777 9900
                                                            a.n. Yayasan Prasama Bhakti</b>. Bukti pembayaran dapat
                                                        diupload saat pengisian formulir pendaftaran.
                                                    </p>
                                                </div>
                                                <div class="col-md-12 col-lg-1">
                                                    <p class="num"><b>2</b></p>
                                                ...
                                                <div class="col-md-12 col-lg-11">
                                                    <p class="text-justify">
                                                        ...
                                                        pendaftaran dengan lengkap dan sebenar-benarnya.
                                                    </p>
                                                </div>
                                                <div class="col-md-12 col-lg-1">
                                                    <p class="num"><b>3</b></p>
                                                ...
                                                <div class="col-md-12 col-lg-11">
                                                    <p class="text-justify">
                                                        ...
                                                        formulir pendaftaran untuk keperluan login ke halaman dashboard
                                                        calon peserta didik.
                                                    </p>
                                                </div>
                                                <div class="col-md-12 col-lg-1">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <button class="btn btn-lg btn-success waves-effect waves-light"
                                                    ...
                                                    disabled="disabled">Formulir Pendaftaran
                                                </button>
                                            </div>
                                        </div>
                                    </form>
